...
volatile BOOL arrCall = { FALSE, FALSE, FALSE, FALSE, FALSE, FALSE }; /* 호출 버튼 상태 저장용 배열 */
/*
...
void fndDrv(byte bFloorNum) { /* 7seg 구동 */
    
    /* 구동부 */
    digitalWrite(HC595_LATCH, LOW);
    shiftOut(HC595_DATA, HC595_CLOCK, LSBFIRST, fndDigits[bFloorNum]);
